...
```
Após definirmos os nossos nós, é preciso encaminhar essas conexões para o `upstream` definido, nesse caso, utiliza-se a diretiva `proxy_pass`.
```nginx
    server {
        location / {
